...
namespace MyWorld.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            city = db.Cities.Include(p => p.Country).FirstOrDefault(t => t.Id == id);
            if (city == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,CountryId,Name,Population")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CountryId,Name,Population")] City city)
        {
            if (ModelState.IsValid)
            {
